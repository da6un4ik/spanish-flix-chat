    ...
    <div className="min-h-screen bg-[#0A0A0A] text-white select-none pb-24 font-sans">
      ...
      <header className="px-6 pt-12 pb-6 flex justify-between items-center sticky top-0 z-40 bg-[#0A0A0A]/90 backdrop-blur-md">
        ...
        <button
          ...
          className="p-2 bg-white/5 rounded-full border border-white/10 active:scale-90 transition-transform"
        >
          ...
          {filteredIdioms.map((idiom) => (
            ...
            >
              ...
              >
                <Heart
                  size={14}
                  className={favorites.includes(idiom.id) ? 'text-red-600 fill-red-600' : 'text-white'}
                />
              </button>
          ...
          >
            <div className="relative h-[48vh]">
              ...
              <button
                ...
                className="absolute top-12 left-6 p-3 bg-black/50 rounded-full border border-white/10"
              >
                <ArrowLeft />
              </button>
            </div>
            ...
            <div className="px-8 pb-32 -mt-16 relative text-left">
              <div className="flex justify-between items-center mb-6">
                <div className="flex items-center gap-3">
                  <h2 className="text-4xl font-black uppercase italic leading-none tracking-tighter">
                    {practiceIdiom.expression}
                  </h2>

                  <button
                    onClick={(e) => speak(practiceIdiom.expression, e)}
                    className="p-2 bg-white/5 rounded-full text-red-600 border border-white/10 active:scale-110 transition-transform"
                  >
                    <Volume2 size={24} />
                  </button>
                </div>
                ...
                <button
                  ...
                  className="p-4 bg-red-600 rounded-full shadow-lg shadow-red-900/40 active:scale-90 transition-transform"
                >
                  <PlayCircle size={24} />
                </button>
              </div>
              ...
              <div
                onClick={(e) => speak(practiceIdiom.example, e)}
                className="bg-white/5 p-6 rounded-3xl border-l-4 border-red-600 mb-10 active:bg-white/10 transition-colors cursor-pointer group"
              >
        ...
        {activeVideoUrl && (
          ...
          >
            <button
              ...
              className="absolute top-12 right-6 p-3 bg-white/10 rounded-full text-white z-50 cursor-pointer"
            >
              <X />
            </button>
            ...
            <video
              ...
              controls
              autoPlay
              className="w-full max-h-[85vh] object-contain z-10 pointer-events-auto"
            />
          </motion.div>
        )}
      </AnimatePresence>
      ...
      <nav className="fixed bottom-0 inset-x-0 h-20 bg-black/80 backdrop-blur-2xl border-t border-white/5 flex items-center justify-center z-[45]">
        <button
          ...
          className="flex flex-col items-center gap-1 text-red-600 uppercase font-black text-[10px] tracking-widest italic active:scale-90 transition-transform"
        >
          <Home size={22} /> Inicio
        </button>
      </nav>
